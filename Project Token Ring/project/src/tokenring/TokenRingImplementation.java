...
import structures.DoublyCircularLinkedList;
...
public class TokenRingImplementation extends TokenRing {
  ...
  private DoublyCircularLinkedList<Workstation> ring;
  ...
  private Workstation next() {
    if (direction) return ring.getNext();
    else return ring.getPrevious();
  }
  ...
  public void tick() {
    ...
    if (ETA == 0 && !waiting) {
      ...
      throw new IllegalStateException(
          "We should not be here. ETA = " + ETA + ", waiting = " + waiting);
    }
  }
}
