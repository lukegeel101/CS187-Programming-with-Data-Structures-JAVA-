...
public class HanoiSolution {
  ...
  /**
   * Returns a {@link ListInterface} of {@link HanoiMove}s that solves the Tower of Hanoi puzzle.
   *
   * @return a {@link ListInterface} of {@link HanoiMove}s that solves the Tower of Hanoi puzzle.
   */
